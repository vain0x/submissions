...
public sealed partial class Program
{
    ...
    bool IsBridgeCore(int u, int eu, int ev, bool[] done)
    {
        done[u] = true;
        ...
        foreach (var v in g[u])
        {
            ...
            if (done[v]) continue;
            if (!IsBridgeCore(v, eu, ev, done)) return false;
        }

        return true;
    }

    bool IsBridge(int eu, int ev)
    {
        var done = n.MakeArray(i => false);
        return IsBridgeCore(eu, eu, ev, done);
    }
