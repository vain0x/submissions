...
public class Program
{
    ...
    Cell EvenCell(int index, int count)
    {
        return trees[index % 2].Query(index, count);
    }
    ...
    {
        return Comparer<int>.Default.Compare(l.EvenCell.Value, r.EvenCell.Value);
    }
    ...
    void AddRange(int l, int r)
    {
        ...
        var range = new Range(EvenCell(l, r - l), l, r - l);
    ...
    public void Run()
    {
        ...
        heap.Enqueue(new Range(trees[0].Query(), 0, allCells.Length));
